...
const MQTT_BROKER = getEnv("MQTT_BROKER");
const MQTT_PORT = parseInt(getEnv("MQTT_PORT") || "1883");
const DEVICE_ID = getEnv("MQTT_DEVICE_ID");
...
export class MQTTHomeAssistantClient {
	...
	static getInstance() {
		return MQTTHomeAssistantClient.instance;
	}
