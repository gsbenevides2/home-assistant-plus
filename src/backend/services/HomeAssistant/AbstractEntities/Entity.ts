...
> {
	...
	// biome-ignore lint/correctness/noUnusedPrivateClassMembers: It`s used in some future features
	...
	sendData(state: SensorState, attributes?: SensorAttributes): Promise<void> {
